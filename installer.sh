...
preflight(){
    ...
    output "Copyright © 2018-2023 meixgan <contact@xxidhost.com>."
    output "Please join my telegram for community support: https://t.me/XxidHosT
    output ""
...
install_dependencies(){
    ...
    if [ "$lsb_dist" = "rhel" ]; then
        ...
        rpm --import https://raw.githubusercontent.com/XxidHosT/Pterodactyl-Script/master/epel9.asc
    ...
    rpm --import https://raw.githubusercontent.com/XxidHosT/Pterodactyl-Script/master/remi9.asc
...
install_pterodactyl() {
    ...
    if [ ${PANEL} = "latest" ]; then
        curl -Lo panel.tar.gz https://github.com/XxidHosT/Panel/panel.tar.gz
    else
        curl -Lo panel.tar.gz https://github.com/XxidHosT/Panel/panel.tar.gz
    fi
